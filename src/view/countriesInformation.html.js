...
export const countrySelectedTable = (
  countrySelectedData,
  ...
  if (countrySelectedData.All.population) {
    population.textContent =
      countrySelectedData.All.population.toLocaleString("en-US");
  } else {
    population.textContent = "not found";
  }
  const capitalCity = document.createElement("td");
  ...
  if (countrySelectedData.All.confirmed) {
    confirmed.textContent =
      countrySelectedData.All.confirmed.toLocaleString("en-US");
  } else {
    confirmed.textContent = "not found";
  }
  const deaths = document.createElement("td");
  ...
  partiallyVaccinated.textContent = (
    countrySelectedVaccineData.All.people_partially_vaccinated -
    countrySelectedVaccineData.All.people_vaccinated
